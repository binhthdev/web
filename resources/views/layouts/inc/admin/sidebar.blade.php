<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
        ...
        <div class="collapse {{ Request::is('admin/category*') ? 'show':'' }}" id="category">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is('admin/category') || Request::is('admin/category/*/edit') ? 'active':'' }}" href="{{ url('admin/category') }}">
        ...
        <li class="nav-item {{ Request::is('admin/products*') ? 'active':'' }}">
            ...
            <div class="collapse {{ Request::is('admin/products*') ? 'show':'' }}" id="products">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('admin/products') || Request::is('admin/products/*/edit') ? 'active':'' }}" href="{{ url('admin/products') }}"
