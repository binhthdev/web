                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <form action="{{ url('change-password') }}" method="POST">
                            @csrf
                            <div class="mb-3 input-pass">
                                <label>Current Password</label>
                                <input type="password" name="current_password" class="form-control input-form" />
                                <div class="toggle-change__pass">
                                    <svg
                            ...
                            <div class="mb-3 input-pass">
                                ...
                                <input type="password" name="password" class="form-control input-form" />
                                <div class="toggle-change__pass">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        class="eye eye-open"
